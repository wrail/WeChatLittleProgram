...
//  登录拦截
  ...
  saveComment:function(e) {
    ...
    if (user == null || user == undefined || user == '') {
      ...
      wx.request({
        url: app.serverUrl + '/comment/saveComment?fatherCommentId=' + fatherCommentId + "&toUserId=" + toUserId,
        method: 'POST',
        header: {
          'content-type': 'application/json', // 默认值
          'headerUserId': user.id,
    ...
    getCommentsList: function(page) {
      ...
      wx.request({
        url: app.serverUrl + '/comment/getVideoComments?videoId=' + videoId + "&page=" + page + "&pageSize=5",
        method: "GET",
        success: function(res) {
          console.log(res.data);
